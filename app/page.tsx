                ...
                <section className={styles.hero}>
                    <div className="container">
                        ...
                        <h1 className={styles.title}>
                            Encontre o <span className={styles.highlight}>imóvel ideal</span><br />
                            para você
                        </h1>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <a href={getWhatsappLink('Atendimento Geral')} target="_blank" className={`btn ${styles.whatsappButton}`}>
                                Falar no WhatsApp
                            </a>
                        </div>
                    </div>
